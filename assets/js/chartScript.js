...
function makeGraph(error, ggData) {
    ...
    var averageGeneratedValue, topYearValue; //Declare the var where the value generated by averageEmissionsFigure will live
    function highlightsFigure(ndx, group, targetDiv, averageValue) {
        dc.numberDisplay("null") //I don't actually want dc to render the value, hence I provide a dummy parent
            ...
            .valueAccessor(function(d) {
                if (averageValue) {
                    averageGeneratedValue = d / countYears; //I generate a value and assign it to the variable           
                } else {
                    topYearValue = d.key;                
                }
            });
    ...
    // var averageGeneratedValue; //Declare the var where the value generated by averageEmissionsFigure will live
    ...
    // var topYearValue; //Declare the var where the value generated by topYearFigure will live
    // function topYearFigure(ndx) {
    //     dc.numberDisplay("null")
    //         .group(totalEmissionsPerYearGroup) //Using totalEmissionsPerYearGroup here will return the most polluting year
    //         .valueAccessor(function(d) {
    //             topYearValue =  d.key;
    //         });
    // }
